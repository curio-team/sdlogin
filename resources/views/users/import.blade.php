    ...
    <div class="container mt-5 inked full-edge">
        <div>
            ...
            <p>
                ...
                extraheren. Dit script haalt de benodigde gegevens op en formatteert ze in een JSON structuur die je
                hieronder kunt plakken.
            </p>
                ...
                <div class="card">
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#importWizard">
                        <div class="card-body">
                            ...
                            <a href="{{ route('groups.batch') }}" target="_blank" class="btn btn-primary">Groepen
                                instellen</a>
                            <div class="mt-3">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#importWizard">
                        <div class="card-body">
                            ...
                            <img src="https://github.com/user-attachments/assets/8d863b42-c4a6-496a-b9b1-8716afb5a7e6"
                                alt="Osiris groepen zoeken" class="img-fluid">
                            <div class="mt-3">
                                <button class="btn btn-success" type="button" data-toggle="collapse"
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('users.import_upload') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea class="form-control input" name="import" id="import" rows="10"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input" name="fake_date" id="fake_date"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 d-flex align-items-center">
                                        <input type="radio" name="find_user_prefix" value="i" id="find_user_i"
                                            checked>
