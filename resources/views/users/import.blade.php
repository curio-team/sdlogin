...
@section('content')
    <div class="container spaced-container">
        ...
        <div class="accordion" id="importWizard">
            <!-- Step 1 -->
            <div class="card">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#importWizard">
                    <div class="card-body">
                        ...
                        <a href="{{ route('groups.batch') }}" target="_blank" class="btn btn-primary">Groepen instellen</a>
                        <div class="mt-3">
                            <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseTwo">Volgende</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#importWizard">
                    <div class="card-body">
                        <p>Open een nieuw tabblad en ga naar Osiris om de groepen op te zoeken.</p>
                        <div class="my-3">
                            <a class="btn btn-primary" href="https://osiris.curio.nl" target="_blank">Open Osiris</a>
                        </div>
                        ...
                        <img src="https://private-user-images.githubusercontent.com/2738114/422734641-8d863b42-c4a6-496a-b9b1-8716afb5a7e6.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..gKuQSj4ZLZfdbzbBl4CoHwwpAVZSg-OhiVmDBfUet6w"
                                ...
                                class="img-fluid">
                        <div class="mt-3">
                            <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseThree">Volgende</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#importWizard">
                    <div class="card-body">
                        <p>Klik op de eerste studentregel in de lijst om de details te bekijken.</p>
                        <div class="mt-3">
                            <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseFour">Volgende</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#importWizard">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary" onclick="window.copyScript(event)">Kopieer script</a>
                        <pre class="bg-light p-3"><code>{{ $exportScript }}</code></pre>
                        <p>Plak dit script in de console en druk op Enter om het uit te voeren.</p>
                        <div class="mt-3">
                            <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseFive">Volgende</button>
                        </div>
            ...
            <div class="card">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#importWizard">
                    <div class="card-body">
                        <p>Wacht tot het script klaar is met uitvoeren en kopieer de resultaten uit de console.</p>
                        <div class="mt-3">
                            <button class="btn btn-success" type="button" data-toggle="collapse" data-target="#collapseSix">Volgende</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#importWizard">
                    <div class="card-body">
