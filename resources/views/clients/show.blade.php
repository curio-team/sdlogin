        ...
        <div>
            ...
            <form action="{{ route('clients.change-name', $client) }}" method="post" class="mt-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <h5><input type="text" value="{{ $client->name }}" class="form-control input" name="name"
                                id="name"></h5>
                    </div>
                    <div class="col-sm-4">
                        <button type="submit" class="button button-secondary"><i class="fa fa-save"></i>Wijzig
                            naam</button>
                    </div>
                </div>
            </form>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>
                        {{ $client->for_development ? 'Ja' : 'Nee' }} <a
